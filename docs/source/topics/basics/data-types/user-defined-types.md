...
describe Cassandra/ScyllaDB types including UDTs, tuples, collections and all basic types
(`int`, `bigint`, `uuid`, etc.).
...
A UDT returned from Cassandra/ScyllaDB is consumed by iterating over its fields similar
