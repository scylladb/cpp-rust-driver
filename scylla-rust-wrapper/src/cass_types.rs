...
) -> CassSharedOwnedPtr<CassDataType> {
...
#[no_mangle]
pub unsafe extern "C" fn cass_data_type_free(data_type: CassSharedOwnedPtr<CassDataType>) {
...
pub unsafe extern "C" fn cass_data_type_set_type_name_n(
    data_type_raw: CassSharedBorrowedPtr<CassDataType>,
    type_name: *const c_char,
...
pub unsafe extern "C" fn cass_data_type_add_sub_type(
    data_type: CassSharedBorrowedPtr<CassDataType>,
    sub_data_type: CassSharedBorrowedPtr<CassDataType>,
) -> CassError {
    let data_type = ArcFFI::as_ref(&data_type).unwrap();
    match data_type
        .get_mut_unchecked()
...
pub unsafe extern "C" fn cass_data_type_add_sub_type_by_name_n(
    ...
    name: *const c_char,
    name_length: size_t,
    sub_data_type_raw: CassSharedBorrowedPtr<CassDataType>,
) -> CassError {
