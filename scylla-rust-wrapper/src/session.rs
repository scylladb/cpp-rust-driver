...
#[no_mangle]
pub unsafe extern "C" fn cass_session_new() -> CassOwnedPtr<CassSession, CMut> {
...
pub unsafe extern "C" fn cass_session_connect(
    session_raw: CassBorrowedPtr<CassSession, CMut>,
    cluster_raw: CassBorrowedPtr<CassCluster, CConst>,
) -> CassOwnedPtr<CassFuture, CMut> {
...
pub unsafe extern "C" fn cass_session_execute_batch(
    session_raw: CassBorrowedPtr<CassSession, CMut>,
    batch_raw: CassBorrowedPtr<CassBatch, CConst>,
) -> CassOwnedPtr<CassFuture, CMut> {
    let session_opt = ArcFFI::cloned_from_ptr(session_raw).unwrap();
...
pub unsafe extern "C" fn cass_session_execute(
    session_raw: CassBorrowedPtr<CassSession, CMut>,
    statement_raw: CassBorrowedPtr<CassStatement, CConst>,
) -> CassOwnedPtr<CassFuture, CMut> {
    let session_opt = ArcFFI::cloned_from_ptr(session_raw).unwrap();
...
pub unsafe extern "C" fn cass_session_prepare_from_existing(
    cass_session: CassBorrowedPtr<CassSession, CMut>,
    statement: CassBorrowedPtr<CassStatement, CMut>,
) -> CassOwnedPtr<CassFuture, CMut> {
...
pub unsafe extern "C" fn cass_session_prepare(
    session: CassBorrowedPtr<CassSession, CMut>,
    query: *const c_char,
) -> CassOwnedPtr<CassFuture, CMut> {
...
pub unsafe extern "C" fn cass_session_prepare_n(
    cass_session_raw: CassBorrowedPtr<CassSession, CMut>,
    query: *const c_char,
    query_length: size_t,
) -> CassOwnedPtr<CassFuture, CMut> {
...
#[no_mangle]
pub unsafe extern "C" fn cass_session_free(session_raw: CassOwnedPtr<CassSession, CMut>) {
...
pub unsafe extern "C" fn cass_session_get_schema_meta(
    session: CassBorrowedPtr<CassSession, CConst>,
...
mod tests {
    ...
    unsafe fn cass_future_wait_check_and_free(fut: CassOwnedPtr<CassFuture, CMut>) {
        ...
        unsafe {
            ...
            ));
            {
                ...
                unsafe fn set_retry_policy_on_stmt(
                    policy: CassBorrowedPtr<CassRetryPolicy, CMut>,
                    statement_raw: CassBorrowedMutPtr<CassStatement, CMut>,
                    batch_raw: CassBorrowedMutPtr<CassBatch, CMut>,
                ) {
                    assert_cass_error_eq!(
