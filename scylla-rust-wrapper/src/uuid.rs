...
#[no_mangle]
pub unsafe extern "C" fn cass_uuid_gen_new() -> CassOwnedMutPtr<CassUuidGen, CMut> {
...
pub unsafe extern "C" fn cass_uuid_gen_new_with_node(
    node: cass_uint64_t,
) -> CassOwnedMutPtr<CassUuidGen, CMut> {
    BoxFFI::into_ptr(Box::new(CassUuidGen {
...
pub unsafe extern "C" fn cass_uuid_gen_time(
    uuid_gen: CassBorrowedMutPtr<CassUuidGen, CMut>,
    output: *mut CassUuid,
) {
...
#[no_mangle]
pub unsafe extern "C" fn cass_uuid_gen_free(uuid_gen: CassOwnedMutPtr<CassUuidGen, CMut>) {
