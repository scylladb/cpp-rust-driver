...
typedef enum  CassErrorSource_ {
  ...
  CASS_ERROR_SOURCE_CLOUD_CONFIG
} CassErrorSource;
...
#define CASS_ERROR_MAPPING(XX) \
  ...
  XX(CASS_ERROR_SOURCE_CLOUD_CONFIG, CASS_ERROR_CLOUD_CONFIG_OPEN_ERROR, 1, "Unable to open cloud config file") \
  XX(CASS_ERROR_SOURCE_CLOUD_CONFIG, CASS_ERROR_CLOUD_CONFIG_PARSE_ERROR, 2, "Unable to parse cloud config file") \
  XX(CASS_ERROR_SOURCE_CLOUD_CONFIG, CASS_ERROR_CLOUD_CONFIG_DECODE_ERROR, 3, "Unable to decode cloud base64 key/cert") \
  XX(CASS_ERROR_SOURCE_CLOUD_CONFIG, CASS_ERROR_CLOUD_CONFIG_VALIDATION_ERROR, 4, "Invalid cloud config") \
  XX(CASS_ERROR_SOURCE_CLOUD_CONFIG, CASS_ERROR_CLOUD_CONFIG_BAD_SSL_PARAMS, 5, "Unable to parse cloud SSL key/cert") \
  XX(CASS_ERROR_SOURCE_CLOUD_CONFIG, CASS_ERROR_CLOUD_CONFIG_UNKNOWN_ERROR, 6, "Unknown cloud error")
