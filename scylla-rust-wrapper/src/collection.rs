...
unsafe extern "C" fn cass_collection_new_from_data_type(
    data_type: CassSharedBorrowedPtr<CassDataType>,
    item_count: size_t,
) -> CassExclusiveMutPtr<CassCollection> {
...
) -> CassSharedBorrowedPtr<CassDataType> {
...
mod tests {
    ...
    fn test_typecheck_on_append_to_collection() {
        unsafe {
            ...
            // untyped map (via cass_collection_new_from_data_type - collection's type is Some(untyped_map)).
            {
                ...
                let untyped_map =
                    cass_collection_new_from_data_type(dt_ptr.clone().into_borrowed(), 2);
    ...
    fn regression_empty_collection_data_type_test() {
        ...
        unsafe {
            ...
            cass_data_type_add_sub_type(empty_set_dt.clone().into_borrowed(), empty_list_dt);
