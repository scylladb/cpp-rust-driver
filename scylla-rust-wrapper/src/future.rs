...
pub type CassFutureCallback =
    Option<unsafe extern "C" fn(future: CassBorrowedPtr<CassFuture, CMut>, data: *mut c_void)>;
...
impl BoundCallback {
    fn invoke(self, fut_ptr: CassBorrowedPtr<CassFuture, CMut>) {
        unsafe {
...
impl CassFuture {
    ...
    pub unsafe fn set_callback(
        &self,
        self_ptr: CassBorrowedPtr<CassFuture, CMut>,
    ...
    fn into_raw(self: Arc<Self>) -> CassOwnedPtr<Self, CMut> {
...
pub unsafe extern "C" fn cass_future_set_callback(
    future_raw: CassBorrowedPtr<CassFuture, CMut>,
...
#[no_mangle]
pub unsafe extern "C" fn cass_future_wait(future_raw: CassBorrowedPtr<CassFuture, CMut>) {
...
pub unsafe extern "C" fn cass_future_error_message(
    future: CassBorrowedPtr<CassFuture, CMut>,
...
#[no_mangle]
pub unsafe extern "C" fn cass_future_free(future_raw: CassOwnedPtr<CassFuture, CMut>) {
...
pub unsafe extern "C" fn cass_future_get_result(
    future_raw: CassBorrowedPtr<CassFuture, CMut>,
) -> CassOwnedPtr<CassResult, CConst> {
    ArcFFI::as_ref(future_raw)
        .unwrap()
...
pub unsafe extern "C" fn cass_future_get_error_result(
    future_raw: CassBorrowedPtr<CassFuture, CMut>,
) -> CassOwnedPtr<CassErrorResult, CConst> {
    ArcFFI::as_ref(future_raw)
        .unwrap()
...
pub unsafe extern "C" fn cass_future_get_prepared(
    future_raw: CassBorrowedPtr<CassFuture, CMut>,
) -> CassOwnedPtr<CassPrepared, CConst> {
    ArcFFI::as_ref(future_raw)
        .unwrap()
...
mod tests {
    ...
    fn cass_future_thread_safety() {
        ...
        struct PtrWrapper(CassBorrowedPtr<'static, CassFuture, CMut>);
        ...
        unsafe {
            ...
            let static_cass_fut_ref = std::mem::transmute::<
                CassBorrowedPtr<'_, CassFuture, CMut>,
                CassBorrowedPtr<'static, CassFuture, CMut>,
            >(cass_fut.borrow());
        ...
        unsafe {
            ...
            let create_future_and_flag = || {
                unsafe extern "C" fn mark_flag_cb(
                    _fut: CassBorrowedPtr<CassFuture, CMut>,
                    data: *mut c_void,
                ) {
