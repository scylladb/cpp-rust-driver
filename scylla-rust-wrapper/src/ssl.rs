...
#[no_mangle]
pub unsafe extern "C" fn cass_ssl_new() -> CassSharedOwnedPtr<CassSsl> {
    openssl_sys::init();
    cass_ssl_new_no_lib_init()
}

#[no_mangle]
pub unsafe extern "C" fn cass_ssl_new_no_lib_init() -> CassSharedOwnedPtr<CassSsl> {
...
#[no_mangle]
pub unsafe extern "C" fn cass_ssl_free(ssl: CassSharedOwnedPtr<CassSsl>) {
    ArcFFI::free(ssl);
}
