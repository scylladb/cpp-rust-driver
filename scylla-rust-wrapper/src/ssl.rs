...
use crate::argconv::{CMut, CassBorrowedPtr};
...
#[no_mangle]
pub unsafe extern "C" fn cass_ssl_new() -> CassOwnedPtr<CassSsl, CMut> {
    openssl_sys::init();
    cass_ssl_new_no_lib_init()
}

#[no_mangle]
pub unsafe extern "C" fn cass_ssl_new_no_lib_init() -> CassOwnedPtr<CassSsl, CMut> {
...
#[no_mangle]
pub unsafe extern "C" fn cass_ssl_free(ssl: CassOwnedPtr<CassSsl, CMut>) {
    ArcFFI::free(ssl);
}
...
pub unsafe extern "C" fn cass_ssl_add_trusted_cert(
    ssl: CassBorrowedPtr<CassSsl, CMut>,
    cert: *const c_char,
) -> CassError {
    if cert.is_null() {
