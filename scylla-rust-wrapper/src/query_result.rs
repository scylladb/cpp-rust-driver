...
pub unsafe extern "C" fn cass_iterator_from_result(
    result: CassSharedBorrowedPtr<CassResult>,
...
#[no_mangle]
pub unsafe extern "C" fn cass_result_free(result_raw: CassSharedOwnedPtr<CassResult>) {
...
unsafe fn result_has_more_pages(result: &CassSharedBorrowedPtr<CassResult>) -> cass_bool_t {
...
pub unsafe extern "C" fn cass_result_row_count(
    result_raw: CassSharedBorrowedPtr<CassResult>,
) -> size_t {
...
mod tests {
    ...
    use super::{
        ...
        CassResultKind, CassResultMetadata, CassRowsResult, CassSharedBorrowedPtr,
    };
    ...
    unsafe fn cass_result_column_name_rust_str(
        result_ptr: CassSharedBorrowedPtr<CassResult>,
        column_index: u64,
    ) -> Option<&'static str> {
...
extern "C" {
    pub fn cass_result_row_count(result: CassSharedBorrowedPtr<CassResult>) -> size_t;
}
extern "C" {
    pub fn cass_result_column_count(result: CassSharedBorrowedPtr<CassResult>) -> size_t;
}
extern "C" {
...
extern "C" {
    pub fn cass_result_column_type(result: CassSharedBorrowedPtr<CassResult>, index: size_t) -> CassValueType;
}
extern "C" {
...
extern "C" {
    pub fn cass_result_first_row(result: CassSharedBorrowedPtr<CassResult>) -> CassBorrowedPtr<CassRow>;
}
extern "C" {
    pub fn cass_result_has_more_pages(result: CassSharedBorrowedPtr<CassResult>) -> cass_bool_t;
}
extern "C" {
